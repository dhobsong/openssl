...
=head1 SYNOPSIS
 ...
 ASN1_INTEGER *X509_ACERT_get0_serialNumber(X509 *x);
 int X509_ACERT_set1_serialNumber(X509 *x, ASN1_INTEGER *serial);
...
X509_ACERT_get0_serialNumber() return an B<ASN1_INTEGER> structure.
