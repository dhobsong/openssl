...
The attribue certificate version number as defined by the standard,
...
The identity of the holder of the attribute certificatate. If the
...
printed witth ANS1_parse_dump().  (X509_FLAG_NO_ATTRIBUTES)
...
I<nmflags> and I<cflags> set to to XN_FLAG_COMPAT and X509_FLAG_COMPAT
respectively.
...
X509_ACERT_print() and X509_ACERT_print_ex() were added in OpenSSL 3.2.
